...
AS SELECT w.Flight_airport_departs AS departure_city_name,
 w.Flight_airport_arrives AS destination_city_name,
 w.Departure_time AS departure_time,
 w.Weekday_day AS departure_day,
 f.Week_number AS departure_week, 
 w.Weekday_year AS departure_year, 
